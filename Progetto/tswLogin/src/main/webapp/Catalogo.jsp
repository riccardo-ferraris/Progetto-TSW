	...
	<div style="display:flex; width:100%">
		...
		<div class="form-popup" id="myForm">
  			<form action="nuovoProdottoServlet" class="form-container" method="post" enctype='multipart/form-data'>
    			...
    			<div class="prezzoQuantit�" style="display:flex">	
    				...
    				<div class="divQuantit�" style="width:45%">
    					<label for="quantit�"><b>Quantit�</b></label>
    					<input type="number" placeholder="Quantit�" name="quantit�" required>
    				</div>
    			</div>
