			...
			<div class="prodottoCarrello">
				...
				<% 
					...
					<div class="checkoutProd">
						<div>
							<a href="Prodotto.jsp?id=<%=seriale%>"><img src="${pageContext.request.contextPath}/gallery/<%=prodottoCarrello.getMacroCategoria()%>/<%=nomeImmagine%>.jpg" style="height:60%"></a><br>
						</div>
						<div>
			...
			<div style="width:20%">
				Totale: <%out.println(String.format("%.2f&euro;", totale));%><br>
		 		<form action="./checkout.jsp<%%>" method="post">
            		<button type="submit" class="cartButton">Procedi all'acquisto</button>
            	</form>
			</div>
		</div>	
